...
import com.dw.ngms.cis.persistence.rowmapper.ManagerNotificationProjectionRowMapper;
...
@Component
@Slf4j
public class NotificationReport implements GenericReport {
    ...
    @Autowired
    public NotificationReport(NamedParameterJdbcTemplate jdbcTemplate,
    ...
    public Resource generateReport(ReportingVm reportingVm) {
        if("PDF".equalsIgnoreCase(reportingVm.getReportFormat())) {
            ...
            return reportUtils.generatePdfOfReport(htmlReport, "ManagerNotification");
        }
    ...
    private String generateManagerNotificationHtmlReport(final ReportingVm reportingVm) {
        ...
        return templateEngine.process("manager-notification.html", context);
    }
    ...
    private List<ManagerNotificationProjection> generateReportData(final ReportingVm reportingVm) {
        ...
        String sql = "SELECT REFERENCE_NO as referenceNumber," +
                ...
                "DATERECEIVED as dateManagerNotified," +
    ...
    private Resource generateCsvResource(List<ManagerNotificationProjection> managerNotificationProjection) {
        try {
            ...
            final File managerNotificationReport = File.createTempFile("managerNotificationReport", ".csv", null);
